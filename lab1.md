...
1. What is the name of the distribution and the OS Type: 
   * **Sophos UTM (formerly Astaro Security Gateway) and Linux OS**
...
**The distro which attracted me is Snakeware. It is a on the list of pending evaluation and it was submitted on 2020-06-02. This distro is quite more interesting because it is based on python their idea is that a Python OS would be fun to use and very easy to contribute to. Also even the beginners would find it relative for using it. For a newbie it is really good if they are provided with distro like this. The goal is to eventually have a usable set of userspace apps and utilities written entirely in Python.**
